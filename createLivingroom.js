...
async function createLivingroom() {
    ...
    //CHIAVE
    if (!player.ownKey()) {
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "key.glb", scene);
    ...
    if (loadModels) {
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "porta-cornice.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "porta-cornice-texture.glb", scene);
    ...
    if (!player.openedDoor1) {
        ...
        if (loadModels) {
            if (lightVersion)
                result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "porta-sliding-vetro.glb", scene);
            else
                result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "porta-sliding-vetro-texture.glb", scene);
    ...
    if (!player.openedDoor3) {
        ...
        if (loadModels) {
            if (lightVersion)
                result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "porta-sliding.glb", scene);   
            else
                result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "porta-sliding-texture.glb", scene);
    ...
    if (document.getElementById("hints").checked) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/cartelli/", "cartello5.glb", scene);
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/cartelli/", "cartello9.glb", scene);
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/cartelli/", "cartello10.glb", scene);
    ...
    if (loadModels) {
            // Scala (modello)
            if (lightVersion)
                result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "staircase.glb", scene);   
            else
                result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "staircase-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        if (!lightVersion) {
            //Quadri (modello)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/", "quadri-ingresso.glb", scene);
        ...
        //Piante (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/", "pianta.glb", scene);
    ...
    if (loadModels) {
        //Gabinetto (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/bagno/", "gabinetto.glb", scene);
    ...
    if (loadModels) {
        //Doccia (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/bagno/", "doccia.glb", scene);
    ...
    if (loadModels) {
        //Lavandino (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/bagno/", "lavandino.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/bagno/", "lavandino-texture.glb", scene);
        ...
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/bagno/", "specchio-lavandino.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/bagno/", "specchio-lavandino-texture.glb", scene);
    ...
    if (loadModels) {
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/", "finestra.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/", "finestra-texture.glb", scene);
    ...
    if (loadModels) {
        //Cucina (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "cucina.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "cucina-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "pensile.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "pensile-texture.glb", scene);
    ...
    if (loadModels) {
        //Frigo (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "frigo.glb", scene);
    ...
    //Chiavi (modello)
    if (lightVersion)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "chiavi.glb", scene);
    else
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "chiavi-texture.glb", scene);
    ...
    if (loadModels) {
        //Secchio (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/cucina/", "secchio.glb", scene);
    ...
    if (loadModels) {
        //Tavolo (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "tavolo.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "tavolo-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "valigie.glb", scene);
    ...
    if (loadModels) {
        //Divano (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "divano.glb", scene);
    ...
    if (loadModels) {
        if (!lightVersion) {
            //Quadro 1 (modello)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "quadro1.glb", scene);
            ...
            //Quadro 2 (modello)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "quadro2.glb", scene);
            ...
            //Quadro 3 (modello)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "quadro3.glb", scene);
            ...
            //Quadro 4 (modello)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "quadro4.glb", scene);
        ...
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "bear.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "bear-texture.glb", scene);
    ...
    if (loadModels) {
        //Caminetto (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "caminetto.glb", scene);
    ...
    if (loadModels) {
        //Sedia 2 (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "sedia.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "sedia-texture.glb", scene);
    ...
    if (loadModels) {
        //Libreria (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "libreria.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "libreria-texture.glb", scene);
    ...
    if (loadModels) {
        //Porta casa (modello)
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "http://localhost:5501/models/furniture/livingroom/salotto/", "porta-casa.glb", scene);
