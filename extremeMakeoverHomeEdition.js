...
async function basicScene(engine) {
	...
	skyboxMaterial.reflectionTexture = await new BABYLON.CubeTexture("https://github.com/SapienzaInteractiveGraphicsCourse/final-project-under-the-bed/tree/main/skybox", scene);
