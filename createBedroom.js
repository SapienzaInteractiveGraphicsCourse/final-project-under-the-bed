...
async function createBedroom() {
    ...
    if (document.getElementById("hints").checked) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/cartelli/", "cartello1.glb", scene);
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/cartelli/", "cartello2.glb", scene);
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/cartelli/", "cartello3.glb", scene);
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/cartelli/", "cartello4.glb", scene);
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/cartelli/", "cartello11.glb", scene);
    ...
    if (loadModels) {
        // Letto (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "letto.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "letto-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "quadri1.glb", scene);
    ...
    if (loadModels) {
        // Comodino (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "comodino.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "comodino-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "orsetto.glb", scene);
    ...
    // Tappeto (modello)
    if (loadModels) {
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/", "tappeto2.glb", scene);
    ...
    if (loadModels) {
        //Cassettiera (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "cassettiera.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "cassettiera-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "giocattoli.glb", scene);
    ...
    if (loadModels) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "toy-box.glb", scene);
    ...
    if (loadModels) {
        //Armadio (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "armadio.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "armadio-texture.glb", scene);
    ...
    if (loadModels) {
        // Scrivania (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "scrivania.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "scrivania-texture.glb", scene);
    ...
    if (loadModels) {
        // Sedia (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "sedia.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "sedia-texture.glb", scene);
    ...
    if (loadModels) {
        ...
        result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "quadro2.glb", scene);
    ...
    if (loadModels) {
        //Libreria (modello)
        if (lightVersion)
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "libreria.glb", scene);
        else
            result = await BABYLON.SceneLoader.ImportMeshAsync("", "models/furniture/bedroom/", "libreria-texture.glb", scene);
